...
//     .filter((category) => category !== "meat") // remove meat
//     .slice(0, 6);
...
//                   {category === "dairy" && "🥤"}
//                   {category === "bakery" && "🍞"}
//                   {!["fruits", "vegetables", "dairy", "bakery"].includes(
//                     category
//                   ) && "🛒"}
//                 </div>
...
//               <div className="text-green-100">Local Farms</div>
//             </div>
//             <div>
...
//                 Free delivery on all orders over $50. Fast and reliable service.
//               </p>
...
//               Discover our most popular and fresh products loved by thousands of
//               customers
//             </p>
//           </div>
...
//                       ${product.price}
//                     </span>
//                     <button className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg transition-all duration-300 transform hover:scale-105">
//                       Add to Cart
//                     </button>
//                   </div>
//                 </div>
